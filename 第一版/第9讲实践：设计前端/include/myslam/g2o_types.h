...
//                                                edge->setMeasurement () 对应下面观测值的类型  3, Eigen::Vector3d,
//                                                                        g2o::VertexSBAPointXYZ, g2o::VertexSE3Expmap是对应edge->setVertex ( 0, .. ); edge->setVertex ( 1, ... );
...
//形参是：观测值维度2，观测值类型Eigen::Vector2d，（即观测值是图像坐标系下的点），该边绑定的顶点类型g2o::VertexSE3Expmap  (pose 位姿  顶点：要优化的变量) 边：误差项
